...
- (void)viewDidLoad {
    ...
    mylayout.itemSize = CGSizeMake((self.view.frame.size.width-10)/2, 300);
    ...
    [myCollection registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"ID"];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UICollectionViewCell *mycell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ID" forIndexPath:indexPath];
